...
export const SystemStatusView: React.FC<SystemStatusViewProps> = ({
  ...
  const avgUptime = systemServices.length > 0
    ...
    : 100;
  const degradedCount = systemServices.filter(s => s.status !== 'Operational').length;
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 text-xs pt-2 border-t border-slate-100 dark:border-slate-800">
              <div>
                ...
                <span className="font-mono font-bold text-slate-900 dark:text-white">{svc.uptimePct}%</span>
              </div>
              <div>
